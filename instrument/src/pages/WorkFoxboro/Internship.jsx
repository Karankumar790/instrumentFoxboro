...
// import { getWork } from '../WorkFoxboro/workFoxSlice'; // Adjust the path
...
//               <TableCell sx={{ color: 'white', fontWeight: 'bold' }}>Technical Qualification</TableCell>
//               <TableCell sx={{ color: 'white', fontWeight: 'bold' }}>Internship Domain</TableCell>
...
//                 <TableCell>
//                   <a href={row.resume} target="_blank" rel="noreferrer">View</a>
//                 </TableCell>
//               </TableRow>
//             ))}
//           </TableBody>
