...
import { submitAdditionalDetails } from './CategoryProductSlice';
...
const CpDetail = () => {
  ...
  const { loading, error, success } = useSelector(state => state.foxboroProduct)
    ...
    <>
      ...
      <Box className="p-6 w-full mx-auto bg-white shadow-lg rounded-lg">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <TextField label="Manufacturer" required name="manufacturer" value={formData.manufacturer} onChange={handleChange} fullWidth />
          <TextField label="Model Name" required name="modelName" value={formData.modelName} onChange={handleChange} fullWidth />
          <TextField label="Key Features" required name="keyFeatures" value={formData.keyFeatures} onChange={handleChange} fullWidth multiline />
          <TextField label="Price" required name="price" value={formData.price} onChange={handleChange} fullWidth />
          <TextField label="Availability" required name="availability" value={formData.availability} onChange={handleChange} fullWidth />
          <TextField label="Reviews" required name="reviews" value={formData.reviews} onChange={handleChange} fullWidth />
          ...
          <TextField label="Model No" required name="modelNo" value={formData.modelNo} onChange={handleChange} fullWidth />
          <TextField label="Application" required name="application" value={formData.application} onChange={handleChange} fullWidth />
          <TextField label="Material" required name="material" value={formData.material} onChange={handleChange} fullWidth />
          <TextField label="Flow Rate" required name="flowRate" value={formData.flowRate} onChange={handleChange} fullWidth />
          <TextField label="Pattern Width" required name="patternWidth" value={formData.patternWidth} onChange={handleChange} fullWidth />
          <TextField label="Package Contains" required name="packageContains" value={formData.packageContains} onChange={handleChange} fullWidth />
