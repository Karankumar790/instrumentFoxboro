...
// export const SER_URL = "http://localhost:3000/api/v1/service";

export const API_URL =
  "https://foxboro-backend-1-ux3d.onrender.com/api/v1/admin";
export const USER_URL =
  "https://foxboro-backend-1-ux3d.onrender.com/api/v1/users";
export const SER_URL =
  "https://foxboro-backend-1-ux3d.onrender.com/api/v1/service";
